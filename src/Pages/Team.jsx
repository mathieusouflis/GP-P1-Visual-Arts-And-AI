          ...
          <div className="w-full h-full flex flex-full gap-10 items-center justify-center">
            <div className="flex justify-around gap-6 mt-10">
              ...
              >
                ...
                <Clasical>
                  Ce projet a été une opportunité pour nous de découvrir ainsi
                  que de comprendre comment fonctionne l’IA et d’apprendre le
                  travail en équipe à l’aide de la méthode SCRUM.
                </Clasical>
                <Clasical>
          ...
          <div className="w-full h-full flex flex-full gap-10 items-center justify-center">
            <div className="flex justify-around gap-6 mt-10">
              ...
              >
                ...
                <Clasical>
                  Notre équipe a travaillé dur pour concevoir un site web qui
                  met en avant l’utilisation innovante des générateurs d'images,
                  et je suis fière de dire que nous avons brillamment présenté
                  notre travail ! 💻
                </Clasical>
                <Clasical>
                  🎯 Mon rôle principal dans ce projet était de sélectionner les
                  images pertinentes pour le site et décrire chacunes et faire
                  une petite recherche sur l iIA de coté.
                </Clasical>
                <Clasical>
                  Ce travail collaboratif m’a permis d'apprendre énormément, de
                  renforcer mes compétences en gestion de projet et d'affiner
                  mon œil pour la création visuelle. 🎨
                </Clasical>
                <Clasical>
                  C'est une expérience enrichissante qui m'a permis de grandir
                  professionnellement et de voir l'importance de l’équipe dans
              ...
              >
                <Clasical>
                  J'ai aprécié travailler dans le cadre de notre projet réalisé
                  en collaboration avec Amélie, Mathieu, Anjara, et Nabil, j’ai
